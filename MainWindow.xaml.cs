...
namespace Dynamic_Lighting_Key_Indicator
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private void MainWindow_Activated(object sender, Microsoft.UI.Xaml.WindowActivatedEventArgs args)
        {
            ...
            _ = MediaPlaybackHandler.Initialize();
        }
        ...
        private void SwapOnOffColor_Click(object sender, RoutedEventArgs e)
        {
            ...
            VKey keyFromButton = ButtonParameters.GetKeyName(button);

            foreach (VKey key in Enum.GetValues<VKey>())
            {
                if (key == keyFromButton)
                {
        ...
        private void TestButton_Click(object sender, object e)
        {
            ...
            _ = MediaPlaybackHandler.PrintCurrentMediaPlaying();
